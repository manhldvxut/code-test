...
<main>
	<div class="container">
        <h2> h2 - This is Menu 01 page detail</h2>
        <h3> h3 - This is Menu 01 page detail</h3> 
        <h4> h4 - This is Menu 01 page detail</h4>
        <p>ディレクトリ設定されました。</p>
    </div>
</main>

<!-- include footer --> 
<?php include_once $_SERVER['DOCUMENT_ROOT'].'/'.DIRNAME.'/assets/inc/footer.php'; ?></main>
